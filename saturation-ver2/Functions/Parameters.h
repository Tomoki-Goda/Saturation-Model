...
double par_start[]  	= {22.40,	1.0,	0.05,		0.5, 	2.0,		1.0,	2.0,		0.1, 	0.1};  
double par_error[]  	= { 1.00,  	0.10,	0.01, 		0.01, 	0.1,		0.1,	0.1,		0.01,	0.01};
double   par_min[] 	= { 0.00,  	0.00,	0.00, 		0.01, 	1.0,		0.5,	1.0,		0.0,	0.0};
double   par_max[] 	= {50.00,  	5.00,	0.20, 		10.00,	10.0,		10,	10.0,		2.0,	2.0};
#else
char * par_name[]	= {"sigma_0",	"A_g",	"lambda_g",	"C", 	"r_max",	"C2",	"r_max2",	"g1",	"g2"};
double par_start[]  	= {22.40,	1.0,	0.05,		0.5, 	0.4,		1.0,	0.4,		0.1, 	0.1};  
double par_error[]  	= { 1.00,  	0.10,	0.01, 		0.01, 	0.01,		0.1,	0.01,		0.01,	0.01};
double   par_min[] 	= { 0.00,  	0.00,	0.00, 		0.01, 	0.01,		0.5,	0.01,		0.0,	0.0};
double   par_max[] 	= {50.00,  	5.00,	0.20, 		10.00,	1.00,		10,	1.00,		2.0,	2.0};
#endif
#endif

...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      COMMON /CONST/ N_F,BETA,N_0, EULERGAMMA
      PARAMETER(K=0)
      N1 = N+1D0;
      N2 = N+2D0;
      N3 = N+3D0;
...
C      TG= (1/BPRIM)*DLOG(DLOG(QQ/LAMBDA2)/DLOG(Q0/LAMBDA2))
      ...
      XGPDF=DCLENSHAW(XGPDF_INTEGRAND,PAR,0d0,150d0,1.0D-15,1.0D-20)
      XGPDF=XGPDF*NORMALIZATION
      IF (ISNAN(XGPDF)) THEN
              WRITE(6,"(A5 E9.2 A5 E9.2)") " X= ",X," Q2= ", QQ
              xgpdf=0d0;
      ENDIF
  100 RETURN
      END

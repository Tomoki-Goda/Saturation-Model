...
plt.legend()
plt.savefig(savedir+"/NewPlots"+name+"/GBSrfix x dependence.png")
...
plt.legend()
plt.savefig(savedir+"/NewPlots"+name+"/GBSrfix x dependenceLogLinear.png")
#plt.show()
plt.clf()
############################## Q dependence ####################################
dataarray=import_array(path+"GBSrfix/Mass0.0-Qup500-Model2-Sud2-rfix1/pointsQ2500x3.txt")
...
plt.savefig(savedir+"/NewPlots"+name+"/GBSrfix Q2 dependence.png")
#plt.show()
...
plt.savefig(savedir+"/NewPlots"+name+"/GBSrfix Q2 dependenceLogLinear.png")
#plt.show()
plt.clf()	

############################## Model dependence ####################################
dataarray=import_array(path+"GBS/Mass0.0-Qup500-Model2-Sud2-rfix0/pointsQ2500x5.txt")
...
dataarray=import_array(path+"GBSPert/Mass0.0-Qup500-Model2-Sud1-rfix0/pointsQ2500x5.txt")
plt.plot(dataarray[0],dataarray[1],label="gbs pert 500 massless",ls="--")

dataarray=import_array(path+"GBSPertrfix/Mass0.0-Qup500-Model2-Sud1-rfix1/pointsQ2500x5.txt")
plt.plot(dataarray[0],dataarray[1],label="gbs pert 500 massless rmax=0.5",ls="-.")

dataarray=import_array(path+"BGK/Mass0.0-Qup500-Model1-SudDefault-rfixDefault/pointsQ2500x5.txt")
plt.plot(dataarray[0],dataarray[1],label="gbk 500 massless",ls="-.")

dataarray=import_array(path+"GBWIntegrated/Mass0.0-Qup500-Model2-Sud0-rfixDefault/pointsQ2500x5.txt")
...
plt.xlabel("r /GeV")
plt.ylabel("sigma/sigma_0")
plt.title("Dipole Cross-Section Q2=500,  x=0.00001")


plt.legend()
plt.savefig(savedir+"/NewPlots"+name+"/Model dependence 500 massless x 5.png")
#plt.show()
...
plt.savefig(savedir+"/NewPlots"+name+"/Model dependence 500 masslessLogLinear.png")
plt.clf()
##########################################################################################
...
dataarray=import_array(path+"BGK/Mass0.0-Qup500-Model1-SudDefault-rfixDefault/pointsQ2500x3.txt")
plt.plot(dataarray[0],dataarray[1],label="gbk 500 massless",ls="-.")
...
plt.legend()
plt.savefig(savedir+"/NewPlots"+name+"/Model dependence 500 massless.png")
#plt.show()
...
dataarray=import_array(path+"BGK/Mass0.0196-Qup500-Model1-SudDefault-rfixDefault/pointsQ2500x3.txt")
plt.plot(dataarray[0],dataarray[1],label="gbk 500 massive",ls="-.")
...
plt.legend()
plt.savefig(savedir+"/NewPlots"+name+"/Model dependence 500 massive.png")
#plt.show()
...
plt.legend()
plt.savefig(savedir+"/NewPlots"+name+"/Model dependence 500 massiveLogLinear.png")
plt.clf()
...
dataarray=import_array(path+"BGK/Mass0.0-Qup50-Model1-SudDefault-rfixDefault/pointsQ250x3.txt")
plt.plot(dataarray[0],dataarray[1],label="gbk 50 massless",ls="-.")
...
plt.legend()
plt.savefig(savedir+"/NewPlots"+name+"/Model dependence 50 massless.png")
#plt.show()

plt.xscale('log')
plt.yscale('linear')

plt.savefig(savedir+"/NewPlots"+name+"/Model dependence 50 masslessLogLinear.png")
plt.clf()
...
dataarray=import_array(path+"BGK/Mass0.0196-Qup50-Model1-SudDefault-rfixDefault/pointsQ250x3.txt")
plt.plot(dataarray[0],dataarray[1],label="gbk 50 massive",ls="-.")
...
plt.legend()
plt.savefig(savedir+"/NewPlots"+name+"/Model dependence 50 massive.png")
#plt.show()

plt.xscale('log')
plt.yscale('linear')

plt.savefig(savedir+"/NewPlots"+name+"/Model dependence 50 massiveLogLinear.png")
#plt.show()
plt.clf()

...
UnintegratedGluonName UnintegratedGluon::_determine_grid_type(string filename) {
  ...
  if (filename.find("KSlinear")  != string::npos) {
    ...
    return grid3d;
  } else if (filename.find("GBW-gluon.dat")  != string::npos) {
    return grid2d;
  } else if (filename.find("GBWS-gluon.dat")  != string::npos) {
    return grid3d;
  } else if (filename.find("BGK-gluon.dat")  != string::npos) {
    return grid2d;
  } else if (filename.find("BGKS-gluon.dat")  != string::npos) {
    return grid3d;
  } else {

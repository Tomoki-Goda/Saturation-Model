...
double par_start[8]	= {	23.0,	0.29,	3.0e-4,	1.26,	0.5,	0.02,	0.08};
...
double par_start[8]  	= {22.40,	1.35,	0.079,		0.38, 	0.5,		1.0,	0.02, 	0.08}; 
...
#else 
char * par_name[8]	= {"sigma_0",	"A_g",	"lambda_g",	"C", 	"r_max",	"C2",	"g1",	"g2"};
double par_start[8]  	= {22.40,	1.35,	0.079,		0.38, 	0.5,		3.0,	0.02, 	0.08}; 

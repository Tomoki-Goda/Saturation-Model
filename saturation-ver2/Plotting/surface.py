...
def main():
    ...
    tags=[]
    try:
        opts, args = getopt.gnu_getopt(sys.argv[1:], "mhs:g:q:t:", ['multiple','help',"save=","grid=","Q2=",'tag'])
    ...
    for gpos,grid in enumerate(grids):
        #grid=grids[gpos]

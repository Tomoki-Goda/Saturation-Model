...
plot '${DATADIR}/${1}/fig161.hst' using 1:4:3 with filledcurves lt rgb "blue" fs transparent pattern 5 t '', \
	 '${DATADIR}/${1}/fig161.hst' using 1:3 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${1}/fig161.hst' using 1:4 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${2}/fig161.hst' using 1:4:3 with filledcurves lt rgb "red" fs transparent pattern 4 t '', \
...
plot '${DATADIR}/${1}/fig162.hst' using 1:4:3 with filledcurves lt rgb "blue" fs transparent pattern 5 t '', \
	 '${DATADIR}/${1}/fig162.hst' using 1:3 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${1}/fig162.hst' using 1:4 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${2}/fig162.hst' using 1:4:3 with filledcurves lt rgb "red" fs transparent pattern 4 t  '', \
...
plot '${DATADIR}/${1}/fig163.hst' using 1:4:3 with filledcurves lt rgb "blue" fs transparent pattern 5 t '', \
	 '${DATADIR}/${1}/fig163.hst' using 1:3 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${1}/fig163.hst' using 1:4 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${2}/fig163.hst' using 1:4:3 with filledcurves lt rgb "red" fs transparent pattern 4 t '', \
...
plot '${DATADIR}/${1}/fig164.hst' using 1:4:3 with filledcurves lt rgb "blue" fs transparent pattern 5 t '', \
	 '${DATADIR}/${1}/fig164.hst' using 1:3 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${1}/fig164.hst' using 1:4 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${2}/fig164.hst' using 1:4:3 with filledcurves lt rgb "red" fs transparent pattern 4 t  '', \
...
plot '${DATADIR}/${1}/fig165.hst' using 1:4:3 with filledcurves lt rgb "blue" fs transparent pattern 5 t '', \
	 '${DATADIR}/${1}/fig165.hst' using 1:3 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${1}/fig165.hst' using 1:4 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${2}/fig165.hst' using 1:4:3 with filledcurves lt rgb "red" fs transparent pattern 4 t '', \
...
plot '${DATADIR}/${1}/fig166.hst' using 1:4:3 with filledcurves lt rgb "blue" fs transparent pattern 5 t '', \
	 '${DATADIR}/${1}/fig166.hst' using 1:3 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${1}/fig166.hst' using 1:4 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${2}/fig166.hst' using 1:4:3 with filledcurves lt rgb "red" fs transparent pattern 4 t  '', \
...
plot '${DATADIR}/${1}/fig167.hst' using 1:4:3 with filledcurves lt rgb "blue" fs transparent pattern 5 t '', \
	 '${DATADIR}/${1}/fig167.hst' using 1:3 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${1}/fig167.hst' using 1:4 with lines lt rgb "blue" t '', \
	 '${DATADIR}/${2}/fig167.hst' using 1:4:3 with filledcurves lt rgb "red" fs transparent pattern 4 t '', \

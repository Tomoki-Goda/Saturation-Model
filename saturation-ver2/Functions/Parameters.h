...
double par_start[8]	= {	23.0,	0.29,	3.0e-4,	1.26,	0.5,	0.5,	0.5};
...
double par_start[8]  	= {22.40,	1.35,	0.079,		0.38, 	0.5,		1.0,	0.5, 	0.5}; 
double par_error[8]  	= { 1.00,  	0.10,	0.05, 		0.01, 	0.01,		0.0,	0.1,	0.1};
double   par_min[8] 	= { 0.00,  	0.00,	0.01, 		0.1, 	0.1,		1.0,	0.0,	0.0};
double   par_max[8] 	= {50.00,  	5.00,	0.20, 		10.00,	1.00,		20,	2.0,	2.0};
#else 
char * par_name[8]	= {"sigma_0",	"A_g",	"lambda_g",	"C", 	"r_max",	"C2",	"g1",	"g2"};
double par_start[8]  	= {22.40,	1.35,	0.079,		0.38, 	0.5,		3.0,	0.5, 	0.5}; 
double par_error[8]  	= { 1.00,  	0.10,	0.05, 		0.01, 	0.01,		0.1,	0.1,	0.1};
double   par_min[8] 	= { 0.00,  	0.00,	0.01, 		0.1, 	0.1,		1.0,	0.0,	0.0};
double   par_max[8] 	= {50.00,  	5.00,	0.20, 		10.00,	1.00,		20,	2.0,	2.0};
#endif
#endif

...
double par_start[7]	= {	23.0,	0.29,	3.0e-4,	1.26,	0.5,	0.2,	0.8};
...
double par_error[7]  	= { 1.00,  	0.10,	0.05, 		0.01, 	0.0,		0.01,	0.01};
double   par_min[7] 	= { 0.00,  	0.00,	0.01, 		0.1, 	0.10,		0.0,	0.0};

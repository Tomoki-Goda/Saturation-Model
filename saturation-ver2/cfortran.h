/* CORR (use 'search' command) means the lines introduced by myself in order to
   get rid of nasty warning meseages. Sebastian Sapeta 
 */
...
//{ 
//if(0==1)                                                              /* CORR*/
//	vkill_trailing("cstr",0,0,0);                                 /* CORR*/
//int i;

C Przykladowe wolanie w fortranie:
C xmi = 1.d-6
C xma = 1.d0
C call simps(xmi,xma,1.D-6,1.D-6,1.D-6,gluon,DUM,res,DUM1,DUM2)
C "gluon" to funkcja, a "res" to wynik numeryczny calkowania

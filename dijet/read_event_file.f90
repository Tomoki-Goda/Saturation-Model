...
!Phi1(1)=deltaPhi(p1Breit,p2Breit) ! difference between azim.angles
Phi1(1)=deltaPhi(p1Breit+p2Breit,obj%act(pFnst(0:3,3))) ! difference between azim.angles
Phi2(1)=deltaPhi(pFnst(0:3,1)+pFnst(0:3,2),pFnst(0:3,3))
Phi3(1)=deltaPhi(p1Breit,p2Breit)
...
!  call h_y( ii)%collect( rapidity(pFnst(0:3,pTordered(ii))) ,eventWeight )
!enddo
call h_Phi1(1)%collect( Phi1(1) ,eventWeight )

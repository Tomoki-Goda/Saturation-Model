/* CORR (use 'search' command) means the lines commented by myself in order to
...
/* PROTOCCALLSFFUN1(LOGICAL,MNUNPT,mnunpt,BYTE)        */              /*CORR*/
/*#define MNUNPT(A2)  CCALLSFFUN1(MNUNPT,mnunpt,BYTE,A2) */            /*CORR*/

...
./plot.py -s "./kt-formula-report1/plots/GBW-gluon.png" -y "linear"  \
	-c "r violet b r violet b" -p "- - -. - - -." -l "rc-\$k_t\$ :\$k_t\$:\$r\$::::::" \
...
./plot.py -s "./kt-formula-report1/plots/GBW-dipole.png"  \
	-c "r violet b r violet b" -p "- - -. - - -." -l "rc-\$k_t\$ :\$k_t\$:\$r\$::::::" \
...
./plot.py -s "./kt-formula-report1/plots/GBW-saturation.png" -a "x: \$ Q_s^2(x)\\;[\\mathrm{GeV^2}]\$" \
	-c "r violet b r violet b" -p "- - -. - - -." -l "rc-\$k_t\$ :\$k_t\$:\$r\$::::::" \
...
./plot.py -s "./kt-formula-report1/plots/BGK-gluon.png" -y "linear" \
	-c "r b r b" -p "- -. - -." -l "\$k_t\$:\$r\$::::::" \
	 -a "\$ k_t^2 \\;[\\mathrm{GeV^2}] \$ : \$\\alpha\\mathcal{F}(x,k_t^2)/\\sigma_0\$" \
...
./plot.py -s "./kt-formula-report1/plots/BGK-dipole.png" \
	-a "\$ r\\; [\\mathrm{GeV}]\$:\$\\sigma/\\sigma_0\$" \
	-c "r b r b" -p "- -. - -." -l "\$k_t\$:\$r\$::::::" \
...
./plot.py -s "./kt-formula-report1/plots/BGK-saturation.png" \

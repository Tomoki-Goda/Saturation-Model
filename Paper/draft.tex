...
\begin{figure}[p]
  \begin{multicols}{2}
    \includegraphics[width=0.47\textwidth]{./plots/GBW-dipole.png}
    \includegraphics[width=0.47\textwidth]{./plots/GBW-gluon.png}
    \includegraphics[width=0.47\textwidth]{./plots/GBW-saturation.png}\par
    \includegraphics[width=0.47\textwidth]{./plots/BGK-dipole.png}
    \includegraphics[width=0.47\textwidth]{./plots/BGK-gluon.png}
    \includegraphics[width=0.47\textwidth]{./plots/BGK-saturation.png}
  \end{multicols}
  ...
  $\sigma_0^{-1}$. \comment{Larger y and x labels}} 
\end{figure}
